...
in_file = "index.md"
out_file = "index.html"
paths = [("./content","./docs"), ("./content/blog/glorfindel", "./docs/blog/glorfindel"), ("./content/blog/tom", "./docs/blog/tom"), ("./content/blog/majesty","./docs/blog/majesty"), ("./content/contact","./docs/contact")]
...
def main() -> None:
    ...
    print(f"-D- num args: {len(sys.argv)}, args: {sys.argv}")
    if len(sys.argv) > 1:
        basepath = sys.argv[1]
    ...
    for input_file_dir, output_file_dir in paths:
        ...
        generate_page(input_file, template_path, output_file, basepath)
